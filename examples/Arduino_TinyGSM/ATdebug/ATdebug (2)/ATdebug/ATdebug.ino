/*
  ...
  DESCRIPTION: Sends data to ThingSpeak every 15 minutes with ESP32 deep sleep + SIM7000 CSCLK sleep
...
bool send_battery_to_thingspeak(float voltage);
...
void setup()
{
    ...
    // Read and send battery voltage to ThingSpeak
    float batteryVoltage = read_battery_voltage();
    Serial.printf("Battery voltage: %.2fV\n", batteryVoltage);
    send_battery_to_thingspeak(batteryVoltage);
...
void wake_from_deep_sleep() {
    Serial.println("Waking SIM7000 from sleep...");
    ...
    Serial.println("SIM7000 wake-up complete");
}
